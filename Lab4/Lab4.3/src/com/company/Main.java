 ...
 * Updated 8/10-21
 * Solves Lab4.3
 * Description: Snabbaste rutten mellan två stater genom en tredje
...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        //C->B
        BreadthFirstPaths bfs1 = new BreadthFirstPaths(SG.graph,w);
        if(!bfs1.hasPathTo(v)){
            System.out.println("Not connected.");
        }
        else{
            for(int stat : bfs1.pathTo(v)){
                if(stat == v){
                    System.out.print(SG.nameOf(stat));
                }
                else{
