 ...
 * Updated 8/10-21
 * Solves Lab4.1
 * Description: Använder Depth First Paths för att ta reda på en rutt mellan två stater
...
public class Main {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        DepthFirstPaths dfs = new DepthFirstPaths(SG.graph,s);
        if(!dfs.hasPathTo(v)){
            System.out.println("Not connected.");
        }
        else{
            for(int stat : dfs.pathTo(v)){
                if(stat == v){
